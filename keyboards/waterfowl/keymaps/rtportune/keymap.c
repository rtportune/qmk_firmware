...
[_SYM] = LAYOUT(
	KC_PERC,	KC_UP,			KC_LBRC,		KC_RBRC,	KC_BSLS,		KC_AMPR,	KC_ASTR,	KC_CIRC,	LCTL(KC_Z),		LCTL(KC_Y),
	KC_LEFT,	KC_DOWN,		KC_RGHT,		KC_RPRN,	KC_PIPE,		KC_DLR,	    KC_PERC,	KC_CIRC,	LCTL(KC_X),		KC_F12,
	KC_DLR,		KC_NO,			KC_LCBR,		KC_RCBR,	KC_AMPR,		KC_EXLM,	KC_AT,		KC_HASH,	LCTL(KC_C),	    LCTL(KC_V),
	KC_1,		LT(3,KC_DEL),	LT(1,KC_SPC),	MO(3),		KC_CAPS,		KC_NUM,		KC_ESC,		KC_BSPC,	LT(2,KC_ENT),	KC_4
),

[_FUNC] =  LAYOUT(
	KC_NO,	KC_NO,			KC_NO,			KC_NO,	KC_NO,			KC_AMPR,	KC_ASTR,	KC_F8,		LCTL(KC_Z),			LCTL(KC_Y),
	KC_NO,	KC_NO,			KC_NO,			KC_NO,	KC_NO,			KC_DLR,	KC_PERC,	KC_CIRC,		LCTL(KC_X),			KC_F12,
	QK_BOOT,KC_NO,			KC_NO,			KC_NO,	KC_NO,			KC_EXLM,	KC_AT,	KC_HASH,		LCTL(KC_C),	    LCTL(KC_V),
	KC_1,	LT(3,KC_DEL),	LT(1,KC_SPC),	KC_TAB,	KC_CAPS,		KC_NUM,	KC_ESC,	KC_BSPC,	LT(2,KC_ENT),	TG(4)
),
